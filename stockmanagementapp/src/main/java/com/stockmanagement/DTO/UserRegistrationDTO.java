...
public class UserRegistrationDTO {
    ...
    @Pattern(regexp = "^(?=.*[0-9])(?=.*[@#_]).{8,125}$", message = "Password must contain at least one number and one special character (@, #, or _).")
    private String password;

//    @NotNull(message = "Role must be specified. Please select a valid role!")
...
//    private boolean isUserActive;
    ...
    @NotNull(message = "Organization code should not be left empty!! Please enter your organization code!!")
